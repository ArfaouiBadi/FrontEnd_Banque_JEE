 ...
 * 
 */
@WebServiceClient(name = "BanqueService", targetNamespace = "http://Service/", wsdlLocation = "http://localhost:8084/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUESERVICE_QNAME = new QName("http://Service/", "BanqueService");
